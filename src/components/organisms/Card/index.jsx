...
export default function Card(props) {
  ...
  return (
    <div className="flex justify-center flex-wrap items-center w-[40%] h-[35%] bg-white border rounded-lg drop-shadow-lg ">
      {children}
    </div>
  );
}
...
function Header(props) {
  ...
  return (
    <div
      className="flex justify-center items-center p-6 w-full cursor-pointer"
      onClick={onClick}
    >
